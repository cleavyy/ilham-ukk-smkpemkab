                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="ilham" name="nama" required>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                <button class="btn btn-warning btn-sm me-1" data-bs-toggle="modal" data-bs-target="#edit<?php echo $row['id_user'] ?>"><i class="bi bi-android2"></i></button>
